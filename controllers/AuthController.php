...
$url = 'http://' . $_SERVER['SERVER_NAME'] . $_SERVER['HTTP_REFERER'];
  ...
  function login() {
    ...
    function sendmail($father_name,$student_name,$mobile,$email,$city,$school_name,$date,$password, $roll_number)
    {
        

        // Initialize PHPMailer
        $mail = new PHPMailer(true);
        $emailtemp = emailtemplate($father_name,$student_name,$mobile,$email,$city,$school_name,$date, $password, $roll_number);
...
}else if (strpos($url,'student-edit') !== false) {
