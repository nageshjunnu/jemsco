...
$user = $userModel->getPaymentByPaymentId($paymentId);
// print_r($user);

$studentId = $user["student_id"];
$userModel = new UserModel();
$studentDetails = $userModel->getStudentById($studentId);
...
// if (isset($_SESSION['payment_id']) && (time() - $_SESSION['payment_id'] > $inactive)) {
//     // last request was more than 2 hours ago
//     session_unset();     // unset $_SESSION variable for this page
//     session_destroy();   // destroy session data
// }
// $_SESSION['payment_id'] = time(); // Update session
?>
...
<body>
    <div class="container">
        ...
        <div class="paper-container">
            ...
            <div class="paper">
                <div class="main-contents">
                    ...
                    <div class="order-number-label">Student Name : <?php echo $studentDetails['student_name']; ?></div>
                        <div class="order-number-label">Transaction ID</div>
                        <div class="order-number"><?php echo $user['payment_id']; ?></div>
        ...
        <a class="btn btn-primary" href="destroy.php">Home</a>
    </div>
</body>
</html>