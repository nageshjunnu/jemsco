...
class UserModel {
    ...
    public function createStudent($student_name, $father_name, $mother_name,$class, $address, $city, $district, $state, $pincode, $school_name,  $school_address,  $school_city, $school_district,  $school_state, $school_pincode, $mobile,$alrernate_mobile, $email,$password, $board_syllabus, $catalyst_olympiad, $roll_number, $role){
        ...
        $query = "INSERT INTO student (student_name, father_name, mother_name, class, address, city, district, state, pincode, school_name, school_address, school_city, school_district, school_state, school_pincode, mobile, email, password, board_syllabus, catalyst_olympiad, roll_number,role) VALUES (:student_name, :father_name, :mother_name, :class, :address, :city, :district, :state, :pincode, :school_name, :school_address, :school_city, :school_district, :school_state, :school_pincode, :mobile, :email, :password, :board_syllabus, :catalyst_olympiad, :roll_number,:role )";
       // echo $query;
        $con = new dbModel();
        $connection = $con->conn();
        try {
